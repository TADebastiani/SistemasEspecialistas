class Perguntas:
    def __init__(self):
        self.level = [
            ...
            ['Dispositivo de proteção está com o ajuste de corrente correto (Corrente nominal * fator de serviço)',
             'ajuste_corrente'],
            ['Existe algum curto circuito entre o contator e o dispositovo de proteção', 'curto_contador'],
            ...
            ['Aplicação que o motor está sendo utilizado é nova', 'aplicacao_nova'],
    ...
    def get(self, atributo):
        return next(x[0] for x in self.level if x[1] == atributo)
